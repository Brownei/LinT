...
import { profileState, useSettingProfileStore } from '../../../hooks/use-auth-store';
...
const SetupProfile = ({ heading }) => {
  ...
  const { data: currentUser, isLoading: loading, error } = useCurrentUser()
  ...
  console.log(areObjectsEqual(profile, profileState.profile))

  useEffect(() => {
    if (areObjectsEqual(profile, profileState.profile) === true) {
