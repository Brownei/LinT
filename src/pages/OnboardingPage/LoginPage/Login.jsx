...
const Login = () => {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.VITE_API_ENDPOINT}/auth/google/login`, {
        accessToken
      })
  ...
  async function handleEmailAndPasswordSignIn(data) {
    setIsLoading(true)
    try {
      const response = await axios.post(`${process.env.VITE_API_ENDPOINT}/auth/login`, {
        email: data.email,
              ...
              <div className='input-values'>
                ...
                <div className='input-login-field'>
                  <div className='input-field'>
                    <input type={showPassword ? 'text' : 'password'} placeholder='Input your password' {...register('password', { required: true })} />
