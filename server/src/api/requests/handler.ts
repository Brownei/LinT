...
export async function acceptRequest(req: Request<Params, {}, RequestBody>, res: Response, next: NextFunction) {
    const { id } = req.params;
    const { userId, postId } = req.body;
...
export async function rejectRequest(req: Request<Params, {}, RequestBody>, res: Response, next: NextFunction) {
    const { id } = req.params;
    const { userId, postId } = req.body;
